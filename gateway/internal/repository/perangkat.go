...
type PerangkatRepository interface {
	List(ctx *context.Context, search *string, limit, offset *int32) (*[]datastruct.PerangkatList, *int32, *util.Error)
...
func (m *perangkatRepository) List(ctx *context.Context, search *string, limit, offset *int32) (*[]datastruct.PerangkatList, *int32, *util.Error) {
