...
type PerangkatService interface {
	List(ctx *context.Context, ent *entity.ServPerangkatList) (*[]datastruct.PerangkatList, *int32, *util.Error)
...
func (m *perangkatService) List(ctx *context.Context, ent *entity.ServPerangkatList) (*[]datastruct.PerangkatList, *int32, *util.Error) {
